  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4">
       <div className="w-full max-w-md glass-card p-8 md:p-12 relative overflow-hidden">
          ...
          <h2 className="text-3xl font-bold text-center mb-2 relative z-10">Sign In</h2>
          <p className="text-center text-slate-500 mb-8 relative z-10">Continue to your Starblog account</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
             ...
             <button 
                type="submit" 
                disabled={loading}
                className="w-full bg-slate-900 text-white font-medium py-3 rounded-full hover:bg-emerald-500 transition-colors disabled:opacity-50"
             >
          ...
          <p className="text-center mt-6 text-sm text-slate-600 relative z-10">
             Don't have an account? <Link to="/register" className="text-emerald-500 font-medium hover:underline">Create one</Link>
          </p>
       </div>
    </div>
  );
